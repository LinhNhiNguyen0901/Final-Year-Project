...
public class LevelManager : MonoBehaviour
{
    ...
    void Start()
    {
        playerInitPosition = FindObjectOfType<mainCharMovement>().transform.position;
    }
    ...
    public void Restart()
    {
        ...
        //FindObjectOfType<movement>().ResetPlayer();
        //FindObjectOfType<movement>().transform.position = playerInitPosition;
